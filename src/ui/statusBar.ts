...
export class StatusBarManager {
    ...
    async selectTargetLanguage() {
        const languages = ['Go', 'Python', 'Rust', 'Java', 'C++', 'C#', 'Ruby', 'PHP', 'Swift', 'Kotlin', 'TypeScript', 'Node.js','JavaScript'];
    ...
    async selectSourceLanguage() {
        const languages = ['Node.js', 'Python', 'Java', 'Go', 'Ruby', 'PHP', 'Rust', 'C++', 'C#', 'Swift', 'Kotlin','TypeScript', 'JavaScript'];
        const selected = await vscode.window.showQuickPick(languages, {
